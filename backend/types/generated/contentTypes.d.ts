...
export interface ApiDynamicTabContentDynamicTabContent
  extends Struct.CollectionTypeSchema {
  collectionName: 'dynamic_tab_contents';
  info: {
    displayName: 'dynamicTabContent';
    pluralName: 'dynamic-tab-contents';
    singularName: 'dynamic-tab-content';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::dynamic-tab-content.dynamic-tab-content'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiHeroSlideHeroSlide extends Struct.SingleTypeSchema {
...
export interface ApiOurStoryOurStory extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    para1: Schema.Attribute.Blocks;
    para2: Schema.Attribute.Blocks;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPartnershipSectionPartnershipSection
  ...
  info: {
    displayName: 'partnership_section';
...
export interface ApiStartupFaqStartupFaq extends Struct.CollectionTypeSchema {
  collectionName: 'startup_faqs';
  info: {
    displayName: 'startupFaq';
    pluralName: 'startup-faqs';
    singularName: 'startup-faq';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dynamic-tab-content.dynamic-tab-content': ApiDynamicTabContentDynamicTabContent;
      ...
      'api::startup-faq.startup-faq': ApiStartupFaqStartupFaq;
