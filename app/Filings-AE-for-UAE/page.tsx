...
export default function UAEBusinessSearchPage() {
 const [query, setQuery] = useState("");

 const handleSearch = (e: React.FormEvent) => {
 e.preventDefault();
 console.log("UAE Business Search:", query);

 // connect UAE registry API later
 };
 ...
 Search registered companies in the UAE by name, license number, or activity.
 </p>
 </div>
 ...
 <input
 type="text"
 placeholder="Enter company name, license number, or keyword..."
 value={query}
 ...
 <p className="text-xs text-gray-500">
 (Connect UAE government registry or API for real data)
 </p>
 </div>
 ) : (
 <div className="text-center text-gray-500 text-sm">
 Start typing to search UAE businesses.
 </div>
 )}
