    ...
    <div className="min-h-screen bg-[#f4f6fa] text-slate-800 font-sans">
      ...
      <div className="bg-gradient-to-r from-white to-slate-50 py-3 text-slate-800 border-b border-slate-100 italic">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-6 text-sm text-gray-500 font-bold">
          Home / MCA Services / <span className="text-amber-700 font-medium tracking-tight">Dematerialisation of Shares</span>
        </div>
      </div>
      ...
      <main className="max-w-[1240px] mx-auto px-4 sm:px-6 py-8 flex flex-col lg:flex-row gap-8 items-start">
             ...
             <div className="bg-white rounded-2xl border border-gray-200 p-4 shadow-lg flex flex-col h-full overflow-hidden">
               <div className="rounded-lg overflow-hidden border border-gray-200 flex-1 flex flex-col">
                <div className="bg-[#9e4a2d] p-6 text-center">
                  <h2 className="text-white text-xl font-bold uppercase tracking-tight italic">DEMATERIALISATION</h2>
                  <div className="mt-2 text-sm text-amber-100 uppercase font-bold italic tracking-tighter">Secure electronic shareholding</div>
                </div>
          ...
          <div className="space-y-12">
             <article className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
                ...
                <div className="prose prose-sm max-w-none text-slate-600 space-y-6 leading-relaxed font-bold italic">
                   ...
                   <h3 className="text-xl font-bold text-slate-900 pt-4 uppercase tracking-tighter italic">What is Dematerialisation of shares?</h3>
                   ...
                   <h3 className="text-lg font-bold text-slate-900 pt-6 tracking-tighter italic uppercase">Applicability (Rule 9B)</h3>
                   ...
                   <h3 className="text-lg font-bold text-slate-900 pt-6 tracking-tighter italic uppercase">Last Date for Compliance</h3>
                   ...
                   <h3 className="text-lg font-bold text-slate-900 pt-6 tracking-tighter italic uppercase underline">How to Convert Physical Shares to Demat?</h3>
                   ...
                   <h3 className="text-lg font-bold text-slate-900 pt-6 tracking-tighter italic uppercase">Penalties for Non-Compliance</h3>
             ...
             <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
                <h3 className="text-xl font-bold text-[#9e4a2d] mb-6 border-b border-gray-50 pb-3 uppercase tracking-tighter italic text-[16px]">Documents Required For Dematerialisation</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-bold italic">
                  {[
        ...
        <aside className="lg:w-80 flex-shrink-0 space-y-6">
           <div className="sticky top-28 space-y-6">
              ...
              <div className="rounded-2xl overflow-hidden shadow-md border border-gray-100 hover:scale-[1.02] transition-transform font-bold italic">
                <img src={ASSETS.companyCompliance} alt="compliance" className="w-full h-auto object-cover" />
                <div className="p-5 bg-white">
                    <div className="text-[14px] text-slate-800 uppercase italic tracking-tighter">Corporate Compliance</div>
                    <div className="text-[11px] text-slate-400 mt-1 font-bold italic">Stay ahead of ROC deadlines</div>
                </div>
              </div>
           </div>
        </aside>
