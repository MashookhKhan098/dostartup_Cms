...
function runCalc(s: CalcState): CalcResult {
  ...
  const partnerDeductions = Math.min(
    partnerSalary + partnerInterest,
    netBusinessIncome,
  );
  ...
  const taxableIncome = Math.max(
    ...
    grossTotal -
      ...
      Math.min(s.ded80g || 0, grossTotal * 0.1),
  );
...
const AI_STEPS = [
  {
    icon: "📋",
    title: "Firm P&L & Balance Sheet Read",
    desc: "AI extracted all accounts from Tally in 6 seconds",
    bg: "bg-[#C15F3C]/20",
  },
  {
    icon: "👥",
    title: "Partner Salary & Interest Verified",
    desc: "Deductions within Section 40(b) limits applied",
    bg: "bg-[#C15F3C]/15",
  },
  {
    icon: "🏦",
    title: "Audit Requirement Checked",
    desc: "Turnover ₹8.2Cr — tax audit required by Oct 31",
    bg: "bg-[#C15F3C]/10",
  },
  {
    icon: "✅",
    title: "ITR-5 Ready to File",
    desc: "0 errors • Surcharge computed • Tax: ₹14,82,400",
    bg: "bg-[#C15F3C]/20",
  },
];
...
const WHY_FEATURES = [
  {
    icon: <BookOpen size={20} className="text-[#C15F3C]" />,
    title: "Auto Books Import",
    desc: "Imports Tally, Zoho Books, QuickBooks P&L and Balance Sheet. AI maps all accounts to correct ITR-5 schedules.",
  },
  {
    icon: <UserCheck size={20} className="text-[#C15F3C]" />,
    title: "Partner Salary Optimizer",
    desc: "Automatically computes maximum allowable partner salary under Section 40(b) to minimize firm's taxable income.",
  },
  {
    icon: <Scale size={20} className="text-[#C15F3C]" />,
    title: "Tax Audit End-to-End",
    desc: "For firms with turnover > ₹1 crore, our empanelled CAs handle Form 3CA/3CB/3CD audit and filing.",
  },
  {
    icon: <Shield size={20} className="text-[#C15F3C]" />,
    title: "Bank-Grade Security",
    desc: "256-bit SSL + SOC2 certified. Your firm's financial data is encrypted end-to-end and never sold.",
  },
];
...
const AI_FEATURES = [
  {
    ...
    title: "Books Auto-Import",
    desc: "Upload Tally XML, Zoho Books CSV, or QuickBooks P&L. AI maps every account to correct ITR-5 schedule automatically.",
  },
  {
    icon: <UserCheck size={26} />,
    title: "Partner Salary & Interest",
    desc: "Computes maximum allowable partner salary (Sec 40(b)) and interest (12% p.a.) to maximize firm deductions.",
  },
  {
    icon: <PieChart size={26} />,
    title: "Depreciation Calculator",
    desc: "Computes WDV and SLM depreciation for all firm assets. Auto-fills Schedule DPM, DEP, and DOE in ITR-5.",
  },
  {
    icon: <Layers size={26} />,
    title: "Multi-Entity Support",
    desc: "Handles Partnership Firms, LLPs, AOPs, BOIs, Trusts, Estates, and Investment Funds in a single platform.",
  },
  {
    icon: <Bell size={26} />,
    title: "AIS/26AS Reconciler",
    desc: "Matches all TDS credits, advance tax, and business receipts in AIS against firm returns to prevent notices.",
  },
  {
    icon: <AlertTriangle size={26} />,
    title: "ITR-5 Notice Shield",
    desc: "280+ validation rules — partner transactions, related party, high-value receipts, and audit disclosures verified.",
  },
];
...
const ENTITY_TABLE = [
  {
    ...
    tax: "30% flat",
    surcharge: "10% if income > ₹1Cr",
    audit: "> ₹1Cr turnover",
    dueDate: "Jul 31 / Oct 31",
  },
  {
    entity: "LLP",
    tax: "30% flat",
...
const TESTIMONIALS = [
  {
    name: "Rajiv & Sons Firm",
    location: "Delhi",
    rating: 5,
    text: "Our partnership firm has 4 partners. DoStartup computed partner salary under 40(b) perfectly, imported from Tally, and filed ITR-5 with audit. Saved ₹45,000 in CA fees!",
    role: "Partnership Firm",
  },
  {
    name: "TechVenture LLP",
    location: "Bangalore",
    rating: 5,
    text: "Our LLP had complex capital gains and multiple partners. DoStartup handled everything — depreciation, partner interest, and the ITR-5 was filed error-free in 2 days.",
    role: "LLP (3 Partners)",
  },
  {
    name: "Heritage Traders AOP",
    location: "Ahmedabad",
    rating: 5,
    text: "As an AOP with 6 members, tax computation was confusing. DoStartup's AI chose between slab rates and MMR, saved us ₹82,000 in tax liability. Outstanding platform!",
    role: "AOP Member",
  },
];
  ...
  return (
    <div className="mb-6">
      ...
      <input
        ...
        style={{
          background: `linear-gradient(to right, #C15F3C 0%, #C15F3C ${pct}%, #e5e7eb ${pct}%, #e5e7eb 100%)`,
        }}
      />
...
function StatusCell({ val }: { val: boolean | string }) {
  ...
  if (val === "~")
    return <span className="text-[#C15F3C] font-bold text-sm">~</span>;
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold text-black leading-[1.08] mb-5">
                ...
                <br />
                For <span className="text-[#C15F3C]">Firms, LLPs & AOPs</span>
              </h1>

              <p className="text-gray-600 text-lg leading-relaxed mb-8 max-w-lg">
                For Partnership Firms, LLPs, AOPs, BOIs, Trusts & Estates. Our
                AI imports your books, computes partner salary under Sec 40(b),
                handles tax audit, and files ITR-5 accurately.
              ...
              <div className="flex gap-8 flex-wrap">
                {[
                  [
                    "50K+",
                    "ITR-5 Filed",
                    <FileText key="f" size={16} className="text-[#C15F3C]" />,
                  ],
                  [
                    "₹200Cr+",
                    "Firm Income Filed",
                    <Building2 key="b" size={16} className="text-[#C15F3C]" />,
                  ],
                  [
                    "4.9★",
                    "Google Rating",
                  ...
                  <div key={String(lbl)} className="flex items-center gap-2">
                    ...
                    <div>
                      <div className="font-display text-2xl font-extrabold text-black">
                        {num}
                      </div>
              ...
              <div className="bg-[#F4F3EE] border-2 border-[#C15F3C]/20 rounded-3xl p-6 shadow-2xl shadow-[#C15F3C]/10 hover:border-[#C15F3C]/40 hover:shadow-[#C15F3C]/20 transition-all duration-300">
                ...
                <div className="mt-4 bg-[#F4F3EE] border border-[#C15F3C]/10 rounded-xl p-4">
                  <div className="flex justify-between text-xs mb-2">
                    ...
                    <span className="font-bold text-[#C15F3C]">
                      75% Complete
                    </span>
                  </div>
                  ...
                  <p className="text-[10px] text-gray-400 mt-2">
                    Computing partner deductions & audit schedules • 2 steps
                    remaining
                  </p>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
              ...
              {["SBI", "HDFC Bank", "ICICI", "Axis Bank", "Kotak"].map((b) => (
                <div
                  key={b}
                  className="text-gray-300 font-bold text-sm hover:text-[#C15F3C] transition-colors"
                >
                  {b}
                </div>
              ))}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 max-w-xl mx-auto text-sm">
                ITR-5 is for entities other than individuals, HUFs, and
                companies. It covers firms, LLPs, AOPs, BOIs, trusts, and
                estates.
              </p>
            </div>
              ...
              <div className="bg-[#F4F3EE] border-2 border-gray-200 rounded-2xl p-6 hover:shadow-lg transition-all">
                ...
                <ul className="space-y-3 mb-5">
                  {[
                    {
                      form: "ITR-1/2/3/4",
                      desc: "Individual or HUF — use ITR-1, 2, 3, or 4 based on income type",
                    },
                    {
                      form: "ITR-6",
                      desc: "Companies (other than those claiming exemption under Sec 11)",
                    },
                    {
                      form: "ITR-7",
                      desc: "Trusts / institutions claiming exemption under Sec 139(4A)/(4C)/(4D)",
                    },
                  ].map((item) => (
                    <li key={item.form} className="flex gap-3 text-sm">
                      <span className="bg-[#C15F3C] text-white text-xs font-bold px-2 py-0.5 rounded-md flex-shrink-0 h-fit">
                        {item.form}
                      </span>
                ...
                <div className="pt-4 border-t border-gray-100">
                  ...
                  <p className="text-xs text-gray-500">
                    DoStartup AI identifies the correct ITR form for your entity
                    type — just answer 3 quick questions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#F4F3EE] border border-gray-200 rounded-2xl p-6 shadow-sm">
              ...
              <div className="mt-3 grid sm:grid-cols-2 gap-2">
                ...
                <p className="text-xs text-gray-600 bg-[#F4F3EE] rounded-xl px-3 py-2 border border-[#C15F3C]/10">
                  ...
                  hands (no double taxation under Section 10(2A)).
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto text-sm">
                ...
                AI-first ITR-5 experience at the lowest price in India.
              </p>
            </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-[#F4F3EE]">
                      ...
                      <th className="px-2 py-3 text-center font-bold text-xs text-gray-500">
                        ClearTax
                      </th>
                      <th className="px-2 py-3 text-center font-bold text-xs text-gray-500">
                        Tax2Win
        ...
        <section className="bg-[#F4F3EE] py-6 px-4 sm:px-6" id="features">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="font-display text-3xl sm:text-4xl font-extrabold text-black mb-3">
                Built for Complex ITR-5 Filing
              </h2>
              <p className="text-gray-500 max-w-2xl mx-auto text-sm">
                Every ITR-5 complexity — partner salary, depreciation, tax
                audit, AOP taxation — handled by AI automatically.
                <span className="block mt-1 text-black font-semibold">
                  99.2% accuracy in firm income computation
                </span>
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="font-display text-3xl sm:text-4xl font-extrabold text-black">
                File ITR-5 in 5 Simple Steps
              </h2>
              <p className="text-gray-500 text-sm mt-2">
                Complex firm returns, simple filing — our AI & CAs handle
                everything
              </p>
            </div>
            ...
            <div className="mt-10 text-center">
              <Link
                href="#pricing"
                className="inline-flex items-center gap-2 text-[#C15F3C] font-semibold text-sm hover:text-[#a34f32]"
              >
              ...
              <div className="grid lg:grid-cols-2">
                ...
                <div className="p-6 border-b lg:border-b-0 lg:border-r border-gray-100">
                  ...
                  <div className="mb-5">
                    ...
                    >
                      ...
                      <option value="llp">
                        LLP — Limited Liability Partnership (30% flat tax)
                      </option>
                      <option value="aop">
                        AOP — Association of Persons (Slab / MMR)
                      </option>
                      <option value="boi">
                        BOI — Body of Individuals (Slab / MMR)
                      </option>
                      <option value="trust">
                        Trust / Estate (30% or Exempt)
                      </option>
                      <option value="estate">
                        Estate of Deceased (Slab rates)
                      </option>
                    </select>
                  </div>
                  ...
                  <div className="mb-2 pb-4 border-b border-gray-100">
                    ...
                    <SliderRow
                      ...
                      value={calc.businessIncome}
                      min={0}
                      max={100000000}
                      step={500000}
                      onChange={(v) => upd("businessIncome", v)}
                      note="Total turnover / receipts of the firm"
                    />
                    <SliderRow
                      label="Total Business Expenses (₹)"
                      value={calc.businessExpenses}
                      min={0}
                      max={80000000}
                      step={500000}
                      onChange={(v) => upd("businessExpenses", v)}
                      note="Rent, salary to staff, depreciation, professional fees, etc."
                    />
                    <SliderRow
                      label="Capital Gains (₹)"
                      value={calc.capitalGains}
                      min={0}
                      max={10000000}
                      step={100000}
                      onChange={(v) => upd("capitalGains", v)}
                    />
                    <SliderRow
                      label="Other Income (₹)"
                  ...
                  {(calc.entityType === "partnership" ||
                    ...
                    <div className="mb-2 pt-4 pb-4 border-b border-gray-100">
                      ...
                      <SliderRow
                        label="Partner Salary (Sec 40(b))"
                        value={calc.partnerSalary}
                        min={0}
                        max={10000000}
                        step={100000}
                        onChange={(v) => upd("partnerSalary", v)}
                        note="Max: ₹3L or 90% of book profit (first ₹3L), 60% on balance"
                      />
                      <SliderRow
                        label="Partner Interest @12% p.a. (Sec 40(b))"
                        value={calc.partnerInterest}
                        min={0}
                        max={5000000}
                        step={50000}
                        onChange={(v) => upd("partnerInterest", v)}
                        note="Max 12% p.a. on partner's capital contribution"
                      />
                    </div>
                  )}
                  ...
                  <div className="pt-4">
                    ...
                    <SliderRow
                      ...
                      max={1000000}
                      step={10000}
                      onChange={(v) => upd("ded80g", v)}
                      note="50% or 100% of donation amount depending on fund"
                    />
                  </div>
                </div>
                ...
                <div className="p-6 bg-[#F4F3EE]">
                  ...
                  >
                    ...
                    <p
                      className={`text-sm font-semibold ${result.auditRequired ? "text-red-800" : "text-black"}`}
                    >
                      {result.auditRequired
                  ...
                  <div className="bg-[#F4F3EE] rounded-2xl border-2 border-orange-500 p-4 mb-4">
                    ...
                    <ResultRow
                      label="Gross Revenue"
                      value={fmt(calc.businessIncome)}
                    />
                    <ResultRow
                      label="Less: Business Expenses"
                      value={`- ${fmt(calc.businessExpenses)}`}
                      color="text-gray-500"
                    />
                    <ResultRow
                    ...
                    {(calc.entityType === "partnership" ||
                      calc.entityType === "llp") && (
                      <ResultRow
                        label="Less: Partner Salary/Interest (40(b))"
                        value={`- ${fmt(result.partnerDeductions)}`}
                        color="text-gray-500"
                      />
                    )}
                    <ResultRow
                  ...
                  <div className="bg-[#F4F3EE] rounded-2xl border border-gray-200 p-4 mb-4 shadow-sm">
                    <ResultRow
                      label={
                        result.flatTaxRate > 0
                          ? `Income Tax @ ${result.flatTaxRate}%`
                          : "Income Tax (Slab rates)"
                      }
                      value={fmt(
                        result.totalTax - result.surcharge - result.cess,
                      )}
                    />
                    <ResultRow
                      label="Surcharge"
                      value={fmt(result.surcharge)}
                      color="text-gray-600"
                    />
                    <ResultRow
                    ...
                    <ResultRow
                      ...
                      tooltip="TDS on business receipts"
                    />
                    <ResultRow
                      label={
                        result.refund >= 0
                  ...
                  <p className="text-center text-[10px] text-gray-400 mt-2">
                    * Estimates only. Consult CA for audit cases, AOP/BOI MMR
                    computation & trust exemptions.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-[#F4F3EE] py-6 px-4 sm:px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="font-display text-3xl sm:text-4xl font-extrabold text-black mb-2">
                Trusted by 50,000+ Firms & LLPs
              </h2>
              <p className="text-gray-500 text-sm">
                See what partnership firms, LLPs & AOPs say about DoStartup.in
              </p>
            </div>
        ...
        <section className="bg-[#F4F3EE] py-6 px-4 sm:px-6 border-t border-gray-100">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-500 text-lg mb-8 max-w-2xl mx-auto">
              Join 50,000+ partnership firms, LLPs & AOPs who trust DoStartup AI
              to file ITR-5 accurately every year.
              <span className="block mt-2 text-black font-semibold">
                Compare with ClearTax, Tax2Win, Quicko, H&R Block & TaxSpanner —
                we're 40% cheaper!
              </span>
