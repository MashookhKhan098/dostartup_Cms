            ...
            <div className="space-y-4 max-h-64 overflow-y-auto pr-2">
              ...
              {updates.map((item, idx) => (
                ...
                >
                  ...
                  <div className="absolute -left-[5px] top-2 w-2 h-2 bg-[#C15F3C] rounded-full"></div>

                  <div className="p-2 hover:bg-[#C15F3C]/10 rounded-lg">

                    <p className="text-[#C15F3C] text-sm font-medium">
                      {item.titile}
                    </p>
