...
const GSTInvoicingComponent = ({
 ...
 <div className="flex gap-3 p-4 border border-[#E5E2DA] rounded-lg hover:border-[#C15F3C] transition">
 ...
 className="w-full px-3 py-2.5 border border-[#E5E2DA] rounded-lg bg-[#F4F3EE] focus:ring-1 focus:ring-[#C15F3C] outline-none text-sm"
 />
 ))}

 <div className="flex gap-2">
 <select className="px-3 py-2.5 border border-[#E5E2DA] rounded-lg bg-[#F4F3EE] text-sm">
 <option>🇮🇳 +91</option>
 </select>
 <input
 type="tel"
 placeholder="Phone"
 className="flex-1 px-3 py-2.5 border border-[#E5E2DA] rounded-lg bg-[#F4F3EE] text-sm"
 />
 </div>

 <label className="flex items-center gap-2 text-xs text-[#6F6B63]">
 ...
 {/* TRUST */}
 <div className="flex flex-wrap justify-center gap-4 mt-6 text-sm text-[#6F6B63]">
