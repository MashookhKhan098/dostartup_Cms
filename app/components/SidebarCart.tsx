...
const SidebarCart = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 sticky top-28 max-w-[400px] mx-auto lg:ml-auto">
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        <div className="space-y-1">
          <input 
            className="w-full bg-white border border-[#E5E7EB] rounded-lg px-4 py-3.5 text-base placeholder:text-[#9CA3AF] focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all outline-none text-[#202939]" 
            placeholder="Name" 
          />
        </div>
        <div className="space-y-1">
        ...
        <div className="flex gap-2">
          ...
          <input 
            className="flex-1 w-full bg-white border border-[#E5E7EB] rounded-lg px-4 py-3.5 text-base placeholder:text-[#9CA3AF] focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all outline-none text-[#202939]" 
          ...
          <label className="flex items-center gap-3 cursor-pointer group">
            <div className="relative flex items-center">
              <input
                ...
                className="w-5 h-5 rounded border-[#D1D5DB] bg-white text-green-500 focus:ring-offset-0 focus:ring-0 cursor-pointer"
              />
            </div>
