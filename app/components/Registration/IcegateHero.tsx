      ...
      const options = {
        ...
        handler: async function (response: any) {
          ...
          try {
            ...
            await supabase.from('icegate_registration').insert({
              name: formData.name,
              email: finalEmail,
              phone_no: formData.phone,
              state: formData.state,
          ...
          setCountdown(5);
          setStep(4); // Use step 4 to signal background state
              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1 space-y-6">
                  ...
                  <div className="flex justify-between items-center text-xs pt-2">
                    ...
                    <button 
                      onClick={() => handleNeedHelpWhatsApp(headingHighlight || heading || "ICEGATE Registration")}
            ...
            >
              <div className="bg-gradient-to-r from-[#C15F3C] to-[#A94E30] px-8 py-6 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-white/80 text-xs text-left">Final check before portal registration payment</p>
                </div>
                <button 
                  onClick={() => setStep(2)}
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="bg-[#F9F8F6] rounded-2xl p-4 border border-[#E5E2DA] space-y-2">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="text-[#10B981] font-bold text-center">PAID</span>
                  </div>
                </div>
                <div className="pt-2">
