...
export default function IcegateHero({
  heading,
  headingHighlight,
  description,
  features,
  ...
  const amount = 2999; // Standard fee for ICEGATE
  ...
  const handlePayment = async () => {
    ...
    try {
      const res = await fetch('/api/create-order', {
        ...
        body: JSON.stringify({ amount, packageName: 'ICEGATE Registration' }),
      });
      ...
      const options = {
        ...
        currency: 'INR',
        name: 'DoStartup',
        description: 'ICEGATE Portal Registration',
        order_id: orderId,
        handler: async function (response: any) {
          ...
          try {
            const finalEmail = user?.email || formData.email || "noemail@icegate.com";
            const { error: dbError } = await supabase.from('icegate_registration').insert({
              name: formData.name,
              email: finalEmail,
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="w-full md:w-64 flex-shrink-0">
                <div className="w-full h-48 bg-gradient-to-br from-[#C15F3C] to-[#A94E30] rounded-xl border border-[#E5E2DA] flex items-center justify-center">
                  <span className="text-white font-bold text-xl text-center px-4">ICEGATE</span>
                </div>
                <div className="mt-4 space-y-2">
                  {["Documents Required", "Verification Process", "Portal Guide"].map((item) => (
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm font-medium text-[#2F2E2B]">4.9/5 Trust Score</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="registration-form" className="lg:w-96 bg-white rounded-2xl shadow-sm border border-[#E5E2DA] overflow-hidden self-start">
            <div className="bg-gradient-to-r from-[#C15F3C] to-[#A94E30] px-6 py-4">
              <h2 className="text-lg font-semibold text-white">Portal Registration</h2>
              <p className="text-sm text-[#F4F3EE]">complete your application online</p>
            </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          ...
                          {[
                             "Andaman", "Andhra Pradesh", "Delhi", "Gujarat", "Karnataka", 
            ...
            >
              <div className="bg-gradient-to-r from-[#C15F3C] to-[#A94E30] px-8 py-6 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-white/80 text-xs">Final check before portal registration payment</p>
                </div>
                <button 
                  onClick={() => setStep(2)}
              ...
              <div className="p-8 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4 border-l border-[#E5E2DA] pl-6">
                    <h4 className="text-[10px] font-bold text-[#B1ADA1] uppercase tracking-wider">Business Info</h4>
                    <div className="space-y-2">
                      <div className="flex flex-col text-sm">
                ...
                <div className="bg-[#F9F8F6] rounded-2xl p-6 border border-[#E5E2DA] flex justify-between items-center">
                  <div>
                    <span className="text-[#6F6B63] text-sm">Registration Fee</span>
                    <p className="text-2xl font-bold text-[#2F2E2B]">₹{amount.toLocaleString()} <span className="text-xs font-normal text-[#B1ADA1]">incl. portal charges</span></p>
                  </div>
                </div>
              ...
              <div className="p-8 space-y-6">
                <div className="space-y-3 text-center">
                  ...
                  <p className="text-[#6F6B63] text-sm leading-relaxed">
                    Your payment of <span className="font-bold text-[#C15F3C]">₹{amount.toLocaleString()}</span> has been received successfully. 
                  </p>
                </div>
                <div className="bg-[#F9F8F6] rounded-2xl p-4 border border-[#E5E2DA] space-y-2">
                  <div className="flex justify-between text-xs">
                    <span className="text-[#6F6B63]">Service</span>
                    <span className="font-semibold text-[#2F2E2B]">ICEGATE Registration</span>
                  </div>
                  <div className="flex justify-between text-xs">
