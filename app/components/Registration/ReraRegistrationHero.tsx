...
export type ReraRegistrationHeroProps = {
  heading?: string;
...
export default function ReraRegistrationHero({
  heading,
  headingHighlight,
  description,
  features,
  buttonText,
}: ReraRegistrationHeroProps) {
  ...
  const handlePayment = async () => {
    ...
    try {
      const res = await fetch("/api/create-order", {
        ...
        body: JSON.stringify({ amount, packageName: "RERA Agent Registration" }),
      });
      ...
      const options = {
        ...
        currency: "INR",
        name: "DoStartup",
        description: "RERA Agent Registration",
        order_id: orderId,
        handler: async function (response: any) {
          ...
          const whatsappMsg =
            ...
            `I have successfully completed the payment. Please proceed with my RERA registration.`;

          const waUrl = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "919999644807"}?text=${encodeURIComponent(whatsappMsg)}`;

          // Save to Supabase
          try {
            const finalEmail = user?.email || formData.email || "noemail@rera.com";
            const { error: dbError } = await supabase.from("tn_rera_registration").insert({
              name: formData.name,
              email: finalEmail,
              phone_no: formData.phone,
            ...
            console.error("Failed to insert RERA record:", dbErr);
          }
          ...
          fetch("/api/send-confirmation", {
            ...
            body: JSON.stringify({
              ...
              phone: formData.phone,
              service: "RERA Agent Registration",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (step === 1) {
      ...
      if (!formData.pan_gstin || !formData.state_region) {
        alert("Please fill in all required fields");
        return;
      }
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="w-full md:w-64 flex-shrink-0">
                <div className="w-full h-48 bg-gradient-to-br from-[#C15F3C] to-[#A94E30] rounded-xl border border-[#E5E2DA] flex items-center justify-center">
                  <span className="text-white font-bold text-xl text-center px-4">RERA Registration</span>
                </div>
                <div className="mt-4 space-y-2">
                  {["Documents Required", "Eligibility", "Process Flow"].map((item) => (
              ...
              <div className="flex-1 space-y-6">
                <div>
                  <div className="inline-flex items-center gap-2 bg-white border border-[#E5E2DA] rounded-full px-3 py-1">
                    ...
                    <span className="text-xs font-medium text-[#C15F3C]">LEGAL COMPLIANCE EXPERTS</span>
                  </div>
                </div>
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <button
                    onClick={() => handleNeedHelpWhatsApp(headingHighlight || heading || "RERA Registration")}
          ...
          <div id="registration-form" className="lg:w-96 bg-white rounded-2xl shadow-sm border border-[#E5E2DA] overflow-hidden self-start">
            <div className="bg-gradient-to-r from-[#C15F3C] to-[#A94E30] px-6 py-4">
              <h2 className="text-lg font-semibold text-white">Apply for RERA Agent</h2>
              <p className="text-sm text-[#F4F3EE]">Complete your registration online</p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {step === 2 && (
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="block text-xs text-[#6F6B63] mb-1">State / Region *</label>
                      <select
                        name="state_region"
                ...
                <div className="flex items-center justify-center gap-2 text-xs text-[#B1ADA1] pt-2">
                  ...
                  <span>Secure · Instant assistance</span>
                </div>
              </form>
            </div>
          </div>
                  ...
                  <div className="space-y-4 border-l border-[#E5E2DA] pl-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-col text-sm">
                        ...
                        <span className="font-semibold text-[#2F2E2B]">{formData.state_region}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="bg-[#F9F8F6] rounded-2xl p-4 border border-[#E5E2DA] space-y-2">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-semibold text-[#2F2E2B]">RERA Agent Registration</span>
                  </div>
                  <div className="flex justify-between text-xs">
