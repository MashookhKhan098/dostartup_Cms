...
export type DarpanRegistrationHeroProps = {
  heading?: string;
...
export default function DarpanRegistrationHero({
  heading,
  headingHighlight,
  description,
  features,
  buttonText,
}: DarpanRegistrationHeroProps) {
  ...
  const handlePayment = async () => {
    ...
    try {
      const res = await fetch("/api/create-order", {
        ...
        body: JSON.stringify({ amount, packageName: "NGO Darpan Registration" }),
      });
      ...
      const options = {
        ...
        currency: "INR",
        name: "DoStartup",
        description: "NGO Darpan Registration",
        order_id: orderId,
        handler: async function (response: any) {
          ...
          const whatsappMsg =
            ...
            `I have successfully completed the payment. Please proceed with my NGO Darpan registration.`;

          const waUrl = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "919999644807"}?text=${encodeURIComponent(whatsappMsg)}`;

          // Save to Supabase
          try {
            const finalEmail = user?.email || formData.email || "noemail@darpan.com";
            const { error: dbError } = await supabase.from("darpan_registration").insert({
              name: formData.name,
              email: finalEmail,
              phone_no: formData.phone,
            ...
            console.error("Failed to insert Darpan record:", dbErr);
          }
          ...
          fetch("/api/send-confirmation", {
            ...
            body: JSON.stringify({
              ...
              phone: formData.phone,
              service: "NGO Darpan Registration",
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="w-full md:w-64 flex-shrink-0">
                <div className="w-full h-48 bg-gradient-to-br from-[#C15F3C] to-[#A94E30] rounded-xl border border-[#E5E2DA] flex items-center justify-center">
                  <span className="text-white font-bold text-xl text-center px-4">NGO Darpan Registration</span>
                </div>
                <div className="mt-4 space-y-2">
                  {["Grants & Funding", "Verification", "Digital Transparency"].map((item) => (
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <button
                    onClick={() => handleNeedHelpWhatsApp(headingHighlight || heading || "NGO Darpan Registration")}
          ...
          <div id="registration-form" className="lg:w-96 bg-white rounded-2xl shadow-sm border border-[#E5E2DA] overflow-hidden self-start">
            <div className="bg-gradient-to-r from-[#C15F3C] to-[#A94E30] px-6 py-4">
              <h2 className="text-lg font-semibold text-white">Apply for Darpan</h2>
              <p className="text-sm text-[#F4F3EE]">NGO Darpan Government Services</p>
            </div>
            ...
            <p className="px-6 pt-1 pb-0 text-[11px] text-[#B1ADA1]">
              {step === 1 ? "Step 1 of 2 – Contact Details" : "Step 2 of 2 – NGO Details"}
            </p>
            ...
            >
              <div className="bg-gradient-to-r from-[#C15F3C] to-[#A94E30] px-8 py-6 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-white/80 text-xs">Verify your NGO information before payment</p>
                </div>
              ...
              <div className="p-8 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4 border-l border-[#E5E2DA] pl-6">
                     <h4 className="text-[10px] font-bold text-[#B1ADA1] uppercase tracking-wider">NGO Details</h4>
                    <div className="space-y-2">
                      <div className="flex flex-col text-sm">
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="bg-[#F9F8F6] rounded-2xl p-4 border border-[#E5E2DA] space-y-2">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-semibold text-[#2F2E2B]">NGO Darpan Registration</span>
                  </div>
                  <div className="flex justify-between text-xs">
