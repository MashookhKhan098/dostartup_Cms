...
export type TrademarkRectificationHeroProps = {
  heading?: string;
...
const FALLBACK_PACKAGES = [
  { label: "Standard Rectification – ₹3,999", amount: 3999 },
  { label: "Premium Rectification – ₹6,999", amount: 6999 },
];

export default function TrademarkRectificationHero({
  heading,
  headingHighlight,
  description,
  features,
  buttonText,
}: TrademarkRectificationHeroProps) {
  ...
  useEffect(() => {
    ...
    const fetchPricing = async () => {
      try {
        const filter = JSON.stringify({ category: { "$regex": "^trademark-rectification$", "$options": "i" } });
  ...
  const handlePayment = async () => {
    ...
    try {
      const res = await fetch("/api/create-order", {
        ...
        body: JSON.stringify({ amount, packageName: "Trademark Rectification" }),
      });
      ...
      const options = {
        ...
        currency: "INR",
        name: "DoStartup",
        description: "Trademark Rectification Service",
        order_id: orderId,
        handler: async function (response: any) {
          ...
          const whatsappMsg =
            `🔔 *New Trademark Rectification Registration*\n\n` +
            `👤 *Name:* ${formData.name}\n` +
            `📞 *Phone:* ${formData.phone}\n` +
            ...
            `I have successfully completed the payment. Please proceed with my Trademark Rectification.`;
          ...
          try {
            ...
            const { error: dbError } = await supabase.from("trademark_rectification").insert({
              name: formData.name,
              email: finalEmail,
              phone_no: formData.phone,
            ...
            console.error("Failed to insert Trademark Rectification record:", dbErr);
          }
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="w-full md:w-64 flex-shrink-0">
                <div className="w-full h-48 bg-gradient-to-br from-[#C15F3C] to-[#A94E30] rounded-xl border border-[#E5E2DA] flex items-center justify-center text-center px-4">
                  <span className="text-white font-bold text-xl">Trademark Rectification</span>
                </div>
                <div className="mt-4 space-y-2">
                  {["Correct Errors", "Update TM Data", "Secure Records"].map((item) => (
              ...
              <div className="flex-1 space-y-6">
                <div className="inline-flex items-center gap-2 bg-white border border-[#E5E2DA] rounded-full px-3 py-1">
                  ...
                  <span className="text-xs font-medium text-[#C15F3C]">RECTIFICATION EXPERTS</span>
                </div>
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <button onClick={() => handleNeedHelpWhatsApp(headingHighlight || heading || "Trademark Rectification")} className="text-[#C15F3C] hover:underline">Need Help?</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="registration-form" className="lg:w-96 bg-white rounded-2xl shadow-sm border border-[#E5E2DA] overflow-hidden self-start">
            <div className="bg-gradient-to-r from-[#C15F3C] to-[#A94E30] px-6 py-4">
              <h2 className="text-lg font-semibold text-white">Apply for Rectification</h2>
              <p className="text-sm text-[#F4F3EE]">Correct your trademark details</p>
            </div>
            ...
            <p className="px-6 pt-1 pb-0 text-[11px] text-[#B1ADA1]">
              {step === 1 ? "Step 1 of 2 – Contact Details" : "Step 2 of 2 – Rectification Details"}
            </p>
            ...
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }}
              ...
              <div className="bg-gradient-to-r from-[#C15F3C] to-[#A94E30] px-8 py-6 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-white/80 text-xs">Final check before Rectification Application</p>
                </div>
              ...
              <div className="p-8 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4 border-l border-[#E5E2DA] pl-6">
                    <h4 className="text-[10px] font-bold text-[#B1ADA1] uppercase tracking-wider">Rectification Details</h4>
                    <div className="space-y-2">
                      {[
                        ["App Number", formData.application_number],
                        ["Brand Name", formData.brand_name],
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="bg-[#F9F8F6] rounded-2xl p-4 border border-[#E5E2DA] space-y-2">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-semibold text-[#2F2E2B]">Trademark Rectification</span>
                  </div>
                  <div className="flex justify-between text-xs">
