...
const linkCls =
  "text-xs text-[#6F6B63] px-3 py-1.5 rounded-xl hover:bg-[#F4F3EE] hover:text-[#C15F3C] whitespace-nowrap transition-all duration-150 block";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center h-16 lg:h-20 gap-3">
          ...
          <div className="hidden lg:flex flex-1 items-center" style={{ overflow: "visible" }}>
            <ul className="flex items-center list-none m-0 p-0" style={{ gap: 0 }}>
              ...
              <NavItem
                label="Compliance"
                panelStyle={{ right: 0, left: "auto", width: "min(760px, calc(100vw - 2rem))" }}
              >
                <div className="grid grid-cols-3 gap-x-8 gap-y-1">
                  {COMPLIANCE.map((item) => (
                    <Link key={item.url} href={item.url} className={linkCls}>{item.label}</Link>
          ...
          <div className="flex items-center gap-1 shrink-0 ml-auto">
            {searchOpen ? (
              <div className="flex items-center bg-white rounded-lg border border-[#E5E2DA] overflow-hidden shadow-sm focus-within:ring-1 focus-within:ring-[#C15F3C]">
                <input
                  autoFocus
                  type="text"
                  placeholder="Search..."
                  className="text-sm px-3 py-2 outline-none bg-transparent w-36 sm:w-48 text-[#2F2E2B] placeholder-[#B1ADA1]"
            ...
            <Link href="#" className="hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-lg text-[13px] font-medium text-[#6F6B63] hover:text-[#C15F3C] hover:bg-[#F4F3EE] transition-all duration-200 whitespace-nowrap">
        ...
        >
          <div className="p-4 space-y-4">
            ...
            <div className="flex gap-3">
              <Link href="#" className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg border border-[#E5E2DA] text-[#6F6B63] hover:text-[#C15F3C] hover:border-[#C15F3C] transition-all duration-200">
                <FiLogIn size={16} /> Login
              </Link>
              <Link href="#" className="flex-1 px-4 py-3 rounded-lg font-semibold text-white shadow-sm transition-all duration-200"
                style={{ background: "#C15F3C" }}
                onMouseOver={(e) => (e.currentTarget.style.background = "#A94E30")}
                onMouseOut={(e) => (e.currentTarget.style.background = "#C15F3C")}
              >
