            ...
            <div className="space-y-6 sticky top-6">
              ...
              <div className="bg-white rounded-2xl border border-[#E5E2DA] p-5">
                ...
                <div className="flex gap-2">
                  <input type="email" placeholder="Your email" className="flex-1 px-3 py-2 border border-[#E5E2DA] rounded-lg text-sm bg-[#F4F3EE] focus:ring-1 focus:ring-[#C15F3C] outline-none" />
                  <button className="px-4 py-2 bg-[#C15F3C] text-white rounded-lg text-sm hover:bg-[#A94E30] transition-all">
                    Subscribe
                  </button>
                </div>
              </div>
