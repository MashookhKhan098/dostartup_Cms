        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-start">
          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6">
              <div>
                <div className="text-xl sm:text-2xl font-bold text-amber-700">50K+</div>
                <div className="text-xs text-gray-500">Registrations</div>
              </div>
              <div className="w-px h-6 sm:h-8 bg-gray-200" />
              <div>
                <div className="text-xl sm:text-2xl font-bold text-amber-700">4.9</div>
                <div className="text-xs text-gray-500">Rating</div>
              </div>
              <div className="w-px h-6 sm:h-8 bg-gray-200" />
              <div>
                <div className="text-xl sm:text-2xl font-bold text-amber-700">24/7</div>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              {[
                ...
                <div key={idx} className="flex items-center gap-2 bg-amber-50/70 rounded-lg p-2 sm:p-2.5">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div className="p-4 sm:p-5">
              {/* Description */}
              <div className="bg-amber-50/70 p-3 sm:p-4 rounded-lg mb-4">
