...
const FssaiServiceDropdown: React.FC<{
 ...
 <input
 className="w-full pl-9 pr-3 py-2 border border-[#E5E2DA] rounded-lg text-sm bg-[#F4F3EE] focus:outline-none focus:ring-1 focus:ring-[#C15F3C]"
...
export default function FSSAIReturnFiling(): React.ReactElement {
 ...
 className="w-full px-4 py-3 bg-[#F4F3EE] border border-[#E5E2DA] rounded-lg text-sm text-[#6F6B63] focus:outline-none focus:ring-1 focus:ring-[#C15F3C] transition"
 >
 ...
 <div className="w-10 h-10 rounded-full bg-[#F4F3EE] border border-[#E5E2DA] flex items-center justify-center text-sm font-semibold text-[#C15F3C]">R</div>
 <div>
