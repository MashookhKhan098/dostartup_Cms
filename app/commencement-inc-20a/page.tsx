    ...
    <div className="min-h-screen bg-[#F4F3EE] text-slate-800 antialiased">
      ...
      <main className="max-w-7xl mx-auto px-6 py-5">
        ...
        <div className="flex flex-col lg:flex-row gap-8 mt-10">
          {/* Left Content */}
          <article className="flex-1 bg-white p-8 rounded-xl border border-slate-100 shadow-sm">
            <div className="mb-6">
          ...
          <aside className="w-full lg:w-80">
              {/* RESTORED RELATED GUIDES BOX - RIGHT SIDE BELOW CONTENT */}
              <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6 mb-6">
                <h4 className="text-xs font-black text-slate-900 mb-4 uppercase tracking-widest border-b pb-3">Related Guides</h4>
                <div className="space-y-4">
                  {[
                    ...
                    "Documents Required for Commencement of Business"
                  ].map((item, idx) => (
                    <div key={idx} className="group flex items-start gap-2 cursor-pointer">
                      <div className="w-1 h-1 rounded-full bg-amber-500 mt-1.5 group-hover:scale-150 transition-transform shrink-0" />
                      <span className="text-[12px] font-bold text-amber-700 group-hover:text-amber-500 leading-snug">
                        {item}
                      </span>
                    </div>
                  ))}
              ...
              <div className="sticky top-28 bg-white p-4 rounded-xl border border-slate-100 shadow-sm">
              <img
      ...
      <DynamicPricingSection category="commencement-inc-20a" />
      <FAQAccordion category="commencement-inc-20a" />
      <PopularSearches />
      <Footer />
