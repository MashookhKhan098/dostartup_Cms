...
export default function ITR1Page() {
    ...
    return (
                ...
                <section className="bg-white py-16 px-4 sm:px-6" id="eligibility">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-10">
                            <p className="text-orange-500 text-xs font-bold uppercase tracking-widest mb-2">Eligibility</p>
        ...
        ══════════════════════════════════════ */}
            ...
            AI FEATURES
        ══════════════════════════════════════ */}
                <section className="bg-slate-900 py-16 px-4 sm:px-6 relative overflow-hidden" id="features">
                    <div className="absolute top-0 right-0 w-96 h-96 bg-orange-500/8 rounded-full blur-3xl pointer-events-none" />
                    <div className="relative z-10 max-w-6xl mx-auto">
                        <div className="text-center mb-10">
                            <p className="text-orange-400 text-xs font-bold uppercase tracking-widest mb-2">AI Technology</p>
        ...
        ══════════════════════════════════════ */}
                <section className="bg-orange-50 py-16 px-4 sm:px-6" id="calculator">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-10">
                            <p className="text-orange-500 text-xs font-bold uppercase tracking-widest mb-2">Free Tool</p>
                        ...
                        <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
                            ...
                            <div className="bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-4 flex items-center justify-between flex-wrap gap-3">
                                ...
                                <span className="bg-white/20 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">AI Powered</span>
                            </div>
                            ...
                            <div className="grid lg:grid-cols-2">
                                ...
                                <div className="p-6 bg-orange-50/40">
                                    ...
                                    <div className={`rounded-2xl p-4 border-2 text-center mb-4 ${result.recommendation === "new" ? "bg-emerald-50 border-emerald-300" : "bg-amber-50 border-amber-300"}`}>
                                        <div className={`text-xs font-bold uppercase tracking-wider mb-1 ${result.recommendation === "new" ? "text-emerald-600" : "text-amber-600"}`}>
                                            🤖 AI Recommendation
                                        </div>
        ...
        ══════════════════════════════════════ */}
            ...
            FINAL CTA BANNER
        ══════════════════════════════════════ */}
                <section className="bg-gradient-to-br from-orange-500 to-orange-700 py-20 px-4 sm:px-6">
