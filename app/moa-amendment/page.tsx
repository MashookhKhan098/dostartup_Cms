...
export default function MOAAmendmentPage() {
 ...
 <li className="hover:text-amber-700 cursor-pointer transition-colors">Notice and Explanatory Statement</li>
 <li className="hover:text-amber-700 cursor-pointer transition-colors">MOA</li>
 <li className="hover:text-amber-700 cursor-pointer transition-colors">Special Resolution</li>
 ...
 <span className="text-xs text-slate-500">(66 reviews)</span>
 </div>
 </div>
 ...
 <li className="flex items-center gap-2">
 <ChevronRight size={14} className="text-amber-600" /> Provide Updated MOA & Approval Letter
 </li>
 </ul>
 <div className="mt-3">
 ...
 <h4 className="mt-4 font-semibold text-slate-900">Altering Name in MOA</h4>
 <p className="mt-2">
...
<AddQuestionModal />
 ...
 <li className="text-amber-700 hover:text-amber-800 cursor-pointer hover:underline">Procedure for Changing MOA Objects Clause</li>
 <li className="text-amber-700 hover:text-amber-800 cursor-pointer hover:underline">Changes to MOA of Company</li>
 <li className="text-amber-700 hover:text-amber-800 cursor-pointer hover:underline">Form INC-33 – SPICe MOA – Procedure</li>
 <li className="text-amber-700 hover:text-amber-800 cursor-pointer hover:underline">MOA of Private Limited Company</li>
 </ul>
 </div>

 <div className="rounded-lg overflow-hidden shadow-sm mb-4 border border-gray-200">
 <img
 src={ASSETS.adRight1}
 ...
 <div className="rounded-lg overflow-hidden shadow-sm mb-6 border border-gray-200">
 <img
 src={ASSETS.dinEkyc}
 alt="din ekyc"
 className="w-full h-56 object-cover"
