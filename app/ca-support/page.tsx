    ...
    <div className="min-h-screen bg-[#F4F3EE] font-sans text-gray-800">
      ...
      <div className="py-3">
        <div className="max-w-[1180px] mx-auto px-6">
          ...
          {/* Features Grid */}
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 bg-[#F4F3EE]">
      ...
      {/* MAIN CONTENT */}
      <main className="max-w-[1180px] mx-auto px-6 py-4 space-y-8 bg-[#F4F3EE]">
        {/* Services Offered */}
        ...
        {/* Combined FAQs and Blog Updates */}
        <section className="bg-[#F4F3EE] py-16 scroll-mt-20 border-t border-[#E5E2DA] -mx-6 px-6">
          <div className="max-w-[1180px] mx-auto">
            {/* Section Heading */}
            <div className="mb-12">
              <h2 className="text-4xl font-bold text-[#0B2545]">
                FAQs for DoStartup CA
              </h2>
            </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden divide-y divide-gray-100">
                  {faqQuestions.map((q, i) => (
                    <div key={i} className="group">
                      <button
                        className="w-full text-left px-6 py-5 flex justify-between items-center text-sm hover:bg-gray-50 transition-colors"
                        onClick={() => setFaqOpen(faqOpen === i ? null : i)}
                      >
                        <span className={`font-bold leading-snug ${faqOpen === i ? "text-[#C15F3C]" : "text-[#201F1D]"}`}>
                          {q}
                        </span>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
          ...
          <form className="mt-4 space-y-3" onSubmit={(e) => e.preventDefault()}>
            ...
            <button className="w-full bg-gradient-to-r from-amber-700 to-amber-800 text-white py-2 rounded-md font-medium flex items-center justify-center gap-2 hover:from-amber-800 hover:to-amber-900 transition-all shadow-md">
        ...
        {/* Popular Searches */}
        <section className="bg-[#F4F3EE] py-12 border-t border-[#E5E2DA] -mx-6 px-6">
      ...
      {/* WhatsApp CTA */}
      <div className="fixed right-6 bottom-6 bg-gradient-to-r from-amber-600 to-amber-700 text-white p-4 rounded-full shadow-2xl z-50 hover:from-amber-700 hover:to-amber-800 transition-all cursor-pointer">
