...
export default function ITR2Page() {
 ...
 AI FEATURES
 ══════════════════════════════════════ */}
 <section className="bg-white py-6 px-4 sm:px-6 relative overflow-hidden" id="features">
 ...
 <p className="text-xs font-bold text-orange-600 mb-3 uppercase ">
 💼 Salary & Other Income
 </p>
 <NumInput
 ...
 <p className="text-xs font-bold text-orange-600 mb-2 uppercase ">
 📈 Capital Gains Tax
 </p>
 <ResultRow
 ...
 <div className="text-xs font-bold uppercase mb-1 flex items-center justify-center gap-1 text-orange-600">
