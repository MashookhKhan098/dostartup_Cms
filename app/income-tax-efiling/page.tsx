                ...
                <div className="bg-white border-b border-gray-100 py-8 px-4 sm:px-6">
                    <div className="max-w-5xl mx-auto">
                        <div className="flex items-start justify-between flex-wrap gap-4">
                            <div>
                                <div className="inline-flex items-center gap-2 bg-orange-50 border border-orange-200 text-orange-500 text-xs font-bold px-3 py-1 rounded-full mb-3 uppercase tracking-wider">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                            ...
                            {step === 2 && (
                                <div className="p-6 sm:p-8">
                                    ...
                                    {/* Salary */}
                                    <div className="bg-orange-50 border border-orange-100 rounded-xl p-4 mb-6">
                                        <h4 className="text-xs font-bold text-orange-600 uppercase tracking-wider mb-4">💼 Salary Income</h4>
                                    ...
                                    <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-6">
                                        <h4 className="text-xs font-bold text-blue-600 uppercase tracking-wider mb-4">🏠 House Property Income</h4>
                                        <div className="grid sm:grid-cols-2 gap-x-4">
                                    ...
                                    <div className="bg-purple-50 border border-purple-100 rounded-xl p-4 mb-6">
                                        <h4 className="text-xs font-bold text-purple-600 uppercase tracking-wider mb-4">📈 Capital Gains & Other Income</h4>
                                        <div className="grid sm:grid-cols-2 gap-x-4">
                                ...
                                <div className="p-6 sm:p-8">
                                    ...
                                    <div className={`rounded-2xl p-5 mb-6 border-2 text-center ${result.recommendation === "new" ? "bg-green-50 border-green-300" : "bg-orange-50 border-orange-300"}`}>
                                        <div className="flex items-center justify-center gap-2 mb-1">
                                            ...
                                            <span className="text-xs font-bold uppercase tracking-wider text-orange-500">AI Recommendation</span>
                                        </div>
