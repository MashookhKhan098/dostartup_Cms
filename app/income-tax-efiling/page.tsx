        ...
        return (
          <div key={label} className="flex items-center">
            <div className="flex flex-col items-center">
              <div className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold border-2 transition-all ${done ? "bg-[#C15F3C] border-[#C15F3C] text-white" : active ? "bg-white border-[#C15F3C] text-[#C15F3C]" : "bg-white border-gray-200 text-gray-400"}`}>
              ...
              {step === 4 && (
                <div className="p-6 sm:p-8">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 mb-6">
                    {/* OLD REGIME */}
                    <div className={`rounded-2xl border-2 p-4 ${result.recommendation === "old" ? "border-[#C15F3C] bg-[#C15F3C]/5" : "border-gray-200 bg-white"}`}>
                    ...
                    {/* NEW REGIME */}
                    <div className={`rounded-2xl border-2 p-4 ${result.recommendation === "new" ? "border-[#C15F3C] bg-[#C15F3C]/5" : "border-gray-200 bg-white"}`}>
                      <div className="flex items-center justify-between mb-3">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  <div className={`rounded-xl p-3 text-center border-2 ${result.recommendation === "old" ? "border-[#C15F3C] bg-[#C15F3C]" : "border-gray-200 bg-white"}`}>
                  ...
                  <div className={`rounded-xl p-3 text-center border-2 ${result.recommendation === "new" ? "border-[#C15F3C] bg-[#C15F3C]" : "border-gray-200 bg-white"}`}>
